SELECT m.id as match_id, m.status as status, m.active_round as round, m.active_set as set, m.active_leg as leg, m.active_match_team_id as match_team_id, m.active_player_id as player_id, mt.team_id as team_id, mtl.id as match_team_leg_id, mt.order
